 ...
 * debugging (system processes, or simple processes such as notepad.exe or calc.exe. Look
 * like I simply hasn't 64bit debugger). 
...
class ProcessManager
{
	...
	static const DWORD RESTART_CODE;
...
public:
	...
	/**
	 * Destructor do nothing except waiting for debug loop terminating
	 */
	~ProcessManager();
};
